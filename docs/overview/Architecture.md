...
Stack Automation is available in three flexible deployment models to meet diverse organizational requirements:

### 1. Multi-Tenant SaaS
- **Shared Infrastructure**: Cost-effective solution with shared Stack Automation backend services
...
- **Dedicated Infrastructure**: Isolated Stack Automation backend services for enhanced security and performance
