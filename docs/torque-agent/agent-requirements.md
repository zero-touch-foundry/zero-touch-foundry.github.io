...
The Stack Automation agent is a lightweight, Docker-based execution component that handles environment provisioning and lifecycle management. This page outlines the infrastructure requirements and specifications needed to run the Stack Automation agent.

## Overview

The Stack Automation agent can be deployed on two types of infrastructure:
...
- **Docker Host**: See [Stack Automation Docker Agent](/torque-agent/torque-docker-agent.md)
- **Kubernetes Cluster**: See [Install and Connect Self-Hosted Agent](/torque-agent/Install-and-connect-self-hosted-agent.md)

## Additional Resources

- [What is the Stack Automation Agent?](/torque-agent/Stack Automation-Agent-Intro.md)
