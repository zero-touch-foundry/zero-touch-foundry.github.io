...
1. If the git repository where the relevant rego file resides was not yet connected to <ProductName />, perform the following :
...
3. Select the policies you want to import into <ProductName />, and click __Generate Policies__.
