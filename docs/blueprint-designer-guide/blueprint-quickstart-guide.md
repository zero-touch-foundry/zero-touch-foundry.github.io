...
These generated blueprints are stored in Stack Automation's backend, and you can customize their inputs, outputs and other details as needed inside an embedded VSCode style IDE from within the Stack Automation Portal. For details on what you can do with generated blueprints, see [Auto-generated Blueprints](./autogenerated-blueprints.md).
...
2. Select one or more assets you want Stack Automation to discover and click __Generate Blueprints__.
...
1. Generate a single-asset blueprint for the first grain in your blueprint, as explained in [Let Stack Automation auto-generate blueprints from your assets](#option-a-let-torque-generate-blueprints-from-your-assets).
