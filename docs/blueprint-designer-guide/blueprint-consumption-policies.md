...
As the blueprint designer, you can define the blueprint's default and max duration configurations or allow it to run indefinitely, to support scenarios that create a deployment that must be always online or delivers a static cloud resource.
