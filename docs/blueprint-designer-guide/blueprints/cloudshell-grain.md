...
The CloudShell grain allows you to integrate Stack Automation with Quali CloudShell. CloudShell blueprints are treated as assets in Stack Automation, extending Stack Automation's capabilities to manage physical resources alongside cloud and container environments.
...
:::tip
We recommend using Stack Automation's auto-discovery capability to quickly model your CloudShell Blueprint within Stack Automation, including all defined inputs and their types.
:::
