...
3. Create a role to be used by Stack Automation to gather the cost information and obtain the following information :
     * __External Id__
     * __Role ARN__
...
To configure Stack Automation’s Cost Allocation Tags:
   1. Launch a sandbox via Stack Automation OR add tags called __torque-account-id__ and __torque-environment-id__ to any resource in your AWS account.
...
3. In the navigation pane of the IAM console, select __Roles__, and then click __Create Role__.
   ...
   2. Under An AWS account ID, select __An AWS account__ and enter 349148204654. (This is the Stack Automation AWS account # where we will query the cost from).
