...
4. Download the service account key in JSON format. This will be used in Stack Automation.
...
### Step 3: Configure Stack Automation

1. Go to **Administration > Cloud Accounts > Cost Collection Target** in Stack Automation.
...
3. Test your credentials in Stack Automation:
