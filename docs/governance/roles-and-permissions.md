...
| [Manage users](#invite-users-to-torque)	   |Invite users to Stack Automation, cancel users invitations, add users to space, change users roles.| ![Locale Dropdown](/img/green-dot.png)        ||||
...
| [Customize space color and icon](/getting-started/getting-started-with-terraform)	   || ![Locale Dropdown](/img/green-dot.png)       |![Locale Dropdown](/img/green-dot.png)||||
