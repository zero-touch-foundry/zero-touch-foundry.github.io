...
|---|---|---|---|
| 1 | Meet Cisco Stack Automation | From planning to automatically-deployed Cisco or 3rd party blueprints in minutes. | Take a tour, Go |
| 2 | Install Stack Automation Management Server | Use a server or VM to let Stack Automation automate your data center infrastructure. | View more, Go |
| 3 | Add Resources Inventory | Onboard resources by adding Intersight integrations, cloud accounts, and more! | View more, Go |
| 4 | Deploy your first blueprint from our Solution Hub | Click and deploy a Cisco or 3rd party blueprint of your choice on your infrastructure. | View more, Go |
| 5 | Verify the status of your deployments | Learn how to visualize your blueprints, identify drifts, and more. | View more, Go |
