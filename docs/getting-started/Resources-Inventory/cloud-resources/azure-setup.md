...
Stack Automation Resources Inventory requires read-only access to inventory and manage cloud resources. The following permissions are required:
...
5. Click Connect.
6. Once connected, Stack Automation Resources Inventory will begin scanning and discovering your cloud resources.