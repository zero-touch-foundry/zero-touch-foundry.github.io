...
Welcome to Stack Automation Cloud Resources, an advanced solution designed to facilitate comprehensive visibility and governance over your cloud infrastructure. Stack Automation Cloud Resources connects to your cloud accounts with read-only permissions, allowing for in-depth discovery, categorization, and curation of cloud resources. Users can filter their resources based on type, location, or Infrastructure as Code (IaC) status, providing fine-grained control over their cloud estate.

Stack Automation Cloud Resources classifies resources by their IaC status as follows:
...
Stack Automation Resources Inventory allows users to curate selected resources into a cart, transforming them into Terraform configuration files and state files. These artifacts are readily available for download, enabling seamless integration into Infrastructure as Code workflows.
...
Stack Automation Cloud Resources offers a suite of features to help you manage your cloud infrastructure effectively:
...
To begin using Stack Automation Resources Inventory, you must connect your cloud account. Currently, AWS and Azure clouds are supported.
...
Upon connecting your account, Stack Automation Resources Inventory will automatically perform a full scan and inventory all resources in your subscription. The Cloud Resources Inventory page presents a comprehensive view of your resources, which can be filtered by:
...
Stack Automation Resources Inventory provides insights into which resources are under IaC management and highlights unmanaged resources that may need to be incorporated into governance frameworks.
...
6. Stack Automation Resources Inventory will generate a Terraform configuration and state file for the curated resources. The curation process may take a few minutes.
...
The Terraform configuration and state files generated by Stack Automation Resources Inventory can be used to manage your cloud resources through Infrastructure as Code. Possible actions include:
...
## Best Practices for Using Stack Automation Resources Inventory

To maximize the benefits of Stack Automation Resources Inventory, consider the following best practices:
...
Currently, Stack Automation Resources Inventory supports only Azure and AWS clouds. Support for other cloud providers, such as Google Cloud, is planned for future releases.

### What Permissions Are Required for Stack Automation Resources Inventory?

Stack Automation Resources Inventory requires read-only permissions to your Azure subscription, specifically the Reader role, to perform resource discovery and inventory.
...
If you are experiencing issues while connecting your Azure account to Stack Automation Resources Inventory, verify the following:

- The provided credentials have read-only permissions.
- The subscription ID is accurate.
- There are no network or firewall settings preventing Stack Automation Resources Inventory from accessing Azure.
...
- Ensure there are no permission issues preventing Stack Automation Resources Inventory from accessing resource details.
- Contact Stack Automation Resources Inventory support if the issue persists.

---

## Support

For further assistance, please contact the Stack Automation Resources Inventory support team at [support@quali.com](mailto:support@quali.com) or visit our [support page](https://support.quali.com).
...
Stack Automation Resources Inventory provides an effective mechanism to address cloud sprawl, enabling you to transition unmanaged resources into managed, codified infrastructure seamlessly integrated into your IaC strategy.