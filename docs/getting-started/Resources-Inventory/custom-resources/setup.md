...
This guide walks you through setting up Custom Resources in Stack Automation, from defining resource types to creating resource instances that can be reserved by blueprints.

## Prerequisites

- Administrator access to Stack Automation
...
1. Navigate to the **Admin** section in Stack Automation
