...
Here is an example of how we execute [Datree.io](https://www.datree.io/) in the above deployment using the Shell grain:
```yaml
grains:
  validate-datree:
    kind: shell
