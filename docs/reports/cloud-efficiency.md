...
- [Realized savings (achieved by Stack Automation)](/reports/cloud-efficiency#the-realized-savings-report)
...
To make the calculation more realistic, Stack Automation then reduces 20% of the cost:
